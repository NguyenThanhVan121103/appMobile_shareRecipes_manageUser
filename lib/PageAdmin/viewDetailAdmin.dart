...
class viewDetailDishesAdmin extends StatefulWidget {
  final String id;
  final String emailUser, passWord;
  const viewDetailDishesAdmin({Key? key, required this.id, required this.emailUser, required this.passWord}) : super(key: key);


  @override
  State<viewDetailDishesAdmin> createState() => _viewDetailDishesAdminState();
}

class _viewDetailDishesAdminState extends State<viewDetailDishesAdmin> {
                ...
                builder: (_, snapshot){
                  ...
                  return PopupMenuButton(
                    ...
                    onSelected: (value){
                      ...
                      if(value == 1){
                        try {
                          deleteDishe(widget.id, disheDetail!['url']);
                        } catch (e) {
                          print("Lỗi khi xóa: $e");
                        }
                      }
                      if(value == 2){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => myHomePageAdmin(emailUser: widget.emailUser, passWord: widget.passWord,)
                          ),
                        );
                      }
                    },
