...
import 'package:da_gourmet/PageAdmin//PopularListDishes.dart';
import 'package:da_gourmet/PageAdmin/viewDetailAdmin.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class CardDishesAdmin extends StatelessWidget {
  final String emailUser,passWord;
  const CardDishesAdmin({Key? key, required this.emailUser, required this.passWord}): super(key: key);
  @override
          ...
          PopupMenuButton(
            itemBuilder: (context){
              return [
                PopupMenuItem<int>(
                  value: 0,
                  child: Text("Món ăn đang phổ biến"),
            ...
            onSelected: (value){
              ...
              if(value == 0){
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PopularCardDishes(emailUser: emailUser, passWord: passWord)
                  ),
                );
              }
            },
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => viewDetailDishesAdmin(id: docId,emailUser: emailUser,passWord: passWord,),
                    ),
                  );
                  print("chay : ${docId}");
                },
