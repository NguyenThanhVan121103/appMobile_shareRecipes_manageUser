...
class SetAdmin extends StatefulWidget {
  final String emailUser;
  const SetAdmin({Key? key, required this.emailUser}): super(key: key);

  @override
  _SetUserState createState() => _SetUserState();
}

class _SetUserState extends State<SetAdmin> {
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: _image != null // avatar
                          ...
                          : AssetImage(
                          'assets/images/avatarAdmin.jpg') as ImageProvider,
                    )
                        : const CircleAvatar(
                      radius: 64,
                      backgroundColor: Colors.cyanAccent,
                      backgroundImage: AssetImage(
                          'assets/images/avatarAdmin.jpg'),
                    ),
